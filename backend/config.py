...
- 项目一：RAG 客服问答系统（LangGraph 版 · Block 级架构，准确率提升 35%，实习期间主导开发）
- 项目二：AI-Me（当前项目，AI 数字分身作品集，独立开发并部署上线）
- 技术栈：LangGraph + LangChain + FastAPI + Python + ChromaDB + DeepSeek-V3 + BGE-Reranker
